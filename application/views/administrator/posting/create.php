    ...
    <div class="container-fluid">
        <div class="row text-capitalize">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-12">
                            <input type="text" class="form-control" name="title" id="title" value="<?= set_value('title'); ?>" placeholder="Enter Title">
                            <?= form_error('title', '<small class="form-text text-danger text-capitalize">* ', '</small>'); ?>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                            <textarea class="textarea" name="article" id="article"><?= set_value('article'); ?></textarea>
            ...
            <div class="col-md-3">
                ...
                <div class="form-row">
                    <div class="form-group col-12">
                        <img src="<?= base_url('') . 'assets/article/default.svg'; ?>" alt="thumbnail" class="img-fluid img-thumbnail w-100 img-preview">
                    </div>
                </div>
