                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right text-capitalize">
                                                    <a href="<?= base_url('') . $controller . '/' . $data['id']; ?>" class="badge badge-pill badge-primary">detail</a>
                                                    <a href="<?= base_url('') . $controller . '/update/' . $data['id']; ?>" class="badge badge-pill badge-success">update</a>
                                                    <?php
                                                    if ($profil['id'] == $data['id']) : ?>
                                                        <span class="badge badge-pill badge-secondary">delete</span>
                                                    <?php else : ?>
                                                        <a href="<?= base_url('') . $controller . '/delete/' . $data['id']; ?>" onclick="return confirm('DELETE <?= $data['name']; ?> ?');" class="badge badge-pill badge-danger">delete</a>
                                                    <?php endif; ?>
